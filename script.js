    ...
    const PF_WORKS = [
      ...
      },
      {
        ...
        d:{
          ...
          result:'<strong>コンテンツマーケのエコシステム連動：</strong><ul><li><strong>メディア:</strong> MIKATA Lab.（ビジネス／ファミリー／事業承継 カテゴリ、「柴田昇の眼」連載 ほか）</li><li><strong>⇄ メルマガ:</strong> 連載「柴田昇の眼」を第 4 回としてメルマガ配信し、媒体間で同一テーマを再接触させる導線</li><li><strong>⇄ ミカタチャンネル（YouTube）:</strong> 動画コンテンツと相互連動</li></ul>「<strong>企画 → 取材 → 執筆 → 作図 → 公開 → メルマガ配信</strong>」の一連を単独で運用できる体制を確立。<br><br>広告を一切かけず、<strong>オーガニック検索（コンテンツSEO）経由で、継続的に問い合わせ・受注を創出</strong>。企画・取材・執筆・デザインを担当した記事が検索流入の主要導線となり、事業の引き合いに直結しています。'
        }
      },
      {
        id:2, year:'2023–2026',
