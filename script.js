    ...
    const PF_WORKS = [
      {
        ...
        d:{
          ...
          role:'企画・実行責任者の1人。SNS戦略・運用、出展者選考、会場設営、当日運営までを櫃田氏と共に計画・実行。<br>※ 本プロジェクトは櫃田氏が主軸となって立ち上げたアートイベントです。メインビジュアルのキャラクター・グラフィックも櫃田氏のデザインによるもの。神田は共同の責任者の1人として、SNS戦略・運用、出展者選考、会場設営、当日運営の企画・実行を担当しました。',
