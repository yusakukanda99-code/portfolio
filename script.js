    ...
    const PF_WORKS = [
      {
        ...
        tags:['SNS','イベント','動画制作','デジタル運用','プライベート'],
      ...
      },
      {
        ...
        d:{
          ...
          result:'<ul><li><strong>2026年2月の広告出稿開始後、相談5件を獲得</strong></li><li>窓口での説明にかかる手間を<strong>大幅に削減</strong>し、相談から成約までの流れをスムーズに</li><li>外部制作会社・複数媒体（Web・冊子）の取りまとめを完遂し、ブランド整合を保って公開・配布まで届けた</li></ul><br>公開URL：<a href="https://mikata-souzoku.jp/" target="_blank" rel="noopener">mikata-souzoku.jp</a>'
        }
      },
      {
        id:24, year:'2026',
