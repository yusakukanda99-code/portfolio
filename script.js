    ...
    const PF_WORKS = [
      {
        ...
        d:{
          ...
          result:'「経営者としての孤独に寄り添ってくれる」という共感の声を得るとともに、既存の士業の枠を超えたクリエイティブな企業姿勢が、新たな層への認知拡大に大きく寄与しました。\n\n【配信媒体・エリア】\n動画プラットフォーム：YouTube、TVer\nWeb媒体：東洋経済、朝日新聞デジタル等（DSP配信）\nモビリティメディア：タクシー広告（近畿・東海エリア／GOタクシーを中心とした配信）\n屋外大型ビジョン：鹿児島（Li-Kaビジョン・センテラスビジョン・天文館ビジョン）、沖縄（あしびビジョン・那覇てんぷすビジョン）',
