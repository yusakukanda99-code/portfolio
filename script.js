  ...
  (function () {
    ...
    const PF_WORKS = [
      ...
      },
      {
        ...
        client:'個人開発',
        d:{
          overview:'保険証券のPDFを読み取り、必要な情報を自社フォーマットへ自動で転記する解析システムを、企画・UI/UX設計・実装まで一人で開発。従来は担当者がPDFを目視で読み解き、手作業で表計算ソフトへ転記していた業務を、<strong>AI（Claude API）による自動抽出に置き換える</strong>ことで、担当者の手作業を代替し、転記ミスを減らすことを目指した個人開発プロジェクトです。',
