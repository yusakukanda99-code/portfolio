  ...
  (function () {
    ...
    const PF_WORKS = [
      ...
      },
      {
        ...
        tags:['デジタル','デザイン'],
        img:'img/works/work_26/work_26.webp',
        hero:'img/works/work_26/work_26_hero.webp',
        client:'個人開発',
        d:{
          overview:'保険証券のPDFを読み取り、必要な情報を自社フォーマットへ自動で転記する解析システムを、企画・UI/UX設計・実装まで一人で開発。従来は担当者がPDFを目視で読み解き、手作業で表計算ソフトへ転記していた業務を、<strong>AI（Claude API）による自動抽出に置き換える</strong>ことで、作業時間の短縮と転記ミスの削減を目指した個人開発プロジェクトです。',
          challenge:'保険証券のPDFは、保険会社ごとに書式がバラバラで、記載項目も多岐にわたります。担当者はそれを一件ずつ目視で読み解き、決まったフォーマットへ手作業で転記していました。この作業は時間がかかるうえ、転記ミスも起こりやすい。さらに、複数の証券・複数の対象者を扱う場合は、突き合わせや集計の手間も大きく、「読み取り」と「整形」を自動化する仕組みが求められていました。',
          approach:'<ul><li><strong>AIによるPDF直接解析：</strong> Claude APIにPDFを直接読み込ませ、あらかじめ定義した項目構造（JSON）で情報を抽出。書式の異なる証券でも、必要な項目を漏れなく拾えるよう設計</li><li><strong>迷わず使えるUI/UX：</strong> ファイルをドラッグ&ドロップするだけで解析が始まる導線、進捗のリアルタイム表示、結果をタブで切り替えて確認できる画面構成など、ITに不慣れな担当者でも直感的に使える操作性を重視</li><li><strong>実運用に耐えるエラー設計：</strong> API混雑時の自動リトライ、大容量PDFやデータ不足の検知など、現場で「止まらない」ための例外処理を作り込み</li></ul>',
          ...
          result:'手作業で行っていた「PDFを読み解き、フォーマットへ転記する」工程を、アップロードから出力まで数ステップに短縮。転記ミスの起きやすい単純作業をAIに任せ、人は「内容の確認・判断」に集中できる状態を目指した。<strong>デザイナーでありながら、業務課題の発見からUI/UX設計、AIを活用した実装までを一気通貫で形にできる</strong>ことを示す、個人開発の実例。'
        }
      },
      {
        id:10, year:'2026',
        ...
        d:{
          overview:'MIKATAグループの採用サイトを、制作会社と連携しながら、現場ヒアリング・IA設計・職種別コンテンツ制作・撮影 (フォトディレクション)・Pardot実装まで担当。<strong>6つのコンサルタント職種ページ、6つの採用ルート、複数の社員インタビュー・座談会</strong>を含む多層IAを、採用ブランディング全体として設計・実装した。加えて、<strong>全49ページの会社紹介・採用資料</strong>を単独でデザインし、配色・タイポ・図解ルールを設計。このデザインが<strong>採用サイト全体のトンマナの基点</strong>となり、媒体横断のブランド一貫性を確立した。',
          ...
          role:'採用ブランディング全体のディレクター兼デザイナーとして<strong>一貫して担当</strong>。現場ヒアリング、採用担当者とのコンテンツ調整、サイト設計、職種別ページ（コンテンツ作成・ロードマップ作成・デザイン）、撮影 (フォトディレクション)、Pardot設定・実装、そして<strong>全49ページの会社紹介・採用資料の単独デザイン</strong>まで。<br>※ 採用サイトの構築は制作会社（クラウドサーカス）との連携によるものです。また墨絵風のブランドビジュアル（「山を登る経営者たち」）は制作会社による既存制作物です。本作品で神田が担当したのは、IA設計、職種別コンテンツの作成、キャリアロードマップの図解、採用サイト・会社紹介資料それぞれのレイアウト・図解・データビジュアル・コンテンツのデザイン、採用写真の撮影 (フォトディレクション)、および Pardot 実装です。',
      ...
      },
      {
        ...
        d:{
          overview:'相続という複雑なテーマに不安を抱えるご家族へ、「安心できる」「何をすればいいかわかる」と感じてもらえるWebサイト＆パンフレットを制作。外部制作会社と連携し、ブランド統一を保って設計・実装。',
          ...
          result:'<a href="https://mikata-souzoku.jp/" target="_blank" rel="noopener">mikata-souzoku.jp</a>（2026年2月公開）。広告クリエイティブと併せて運用を開始し、相続手続きに不安を持つご家族への相談導線を確立した。'
        }
      },
      {
        id:6, year:'2025',
        ...
        client:'ながくてアートフェスティバル運営',
        d:{
          overview:'母校の元教授・卒業生とともに立ち上げた地域アートイベントの企画・運営に、共同責任者の1人として参加。Instagramでの運用と現場運営（規約・搬入方法など）の両輪で、<strong>多くの方にご来場</strong>いただきました。',
          challenge:'母校の元教授・卒業生2名の計3名でチームを組成し、出身コースとも連携して立ち上げたプロジェクト。作品性と幅広い層への訴求を両立させながら、集客チャネルも会場運営も、仕組みのない白紙の状態から構築する必要がありました。',
          ...
          role:'企画・実行責任者の1人。SNS戦略・運用、出展者選考、会場設営、当日運営までを櫃田氏と共に計画・実行。<br>※ 本プロジェクトは、母校の元教授である櫃田氏が主軸となって立ち上げたアートイベントです。メインビジュアルのキャラクター・グラフィックも櫃田氏のデザインによるもの。神田は卒業後も続く大学時代のつながりを通じて参加し、共同責任者の1人として、SNS戦略・運用、出展者選考、会場設営、当日運営の企画・実行を担当しました。',
          creative:'幅広い層に届くよう、<strong>櫃田氏デザインの親しみやすいポップなキャラクター</strong>をメインビジュアルに使用。明るいオレンジを基調に、動画ではキャラクターを大きく動かし効果音を添えて、初めて見る人でも気軽に手に取れる雰囲気を演出しました。',
          result:'<ul><li><strong>目標を上回る動員</strong></li><li><strong>出展応募:22名</strong></li><li>Instagram（運用2ヶ月時点）：<strong>平均再生時間17秒</strong> ／ <strong>スキップ率64%</strong> ／ <strong>プロフィール流入率36.3%</strong></li><li><strong>地域アートイベントとしての継続基盤を確立</strong>。次回以降に活かせる運営データと関係者ネットワークを蓄積</li></ul><br>※ 保存率は伸びず、制作期間の短さも課題として残った。次回は「応募に直結する誘導設計」のブラッシュアップに取り組む方針。<br><br>▶ 運用したInstagramアカウント：<a href="https://www.instagram.com/hits_mcd_artbook.project/" target="_blank" rel="noopener">@hits_mcd_artbook.project</a>'
        }
      },
      {
        ...
        client:'ミカタ税理法人（ミカタグループ）',
        d:{
          overview:'オーナー経営者向けオウンドメディア「MIKATA Lab.」に、企画から運用まで一貫して関与。記事アイキャッチの統一デザインを軸に、執筆者・専門家との調整、原稿の編集・サムネイル制作を継続担当。<strong>「マネーフォワード クラウド」連載 (全 3 回) のみ、企画・取材・執筆・作図・サムネイルまで単独で完遂</strong>。メルマガ／YouTube と連動した<strong>コンテンツマーケのエコシステムの中核</strong>として運用。',
          ...
          approach:'<ul><li><strong>統一トーンで記事アイキャッチを量産：</strong> ミカタブランドのトンマナを軸に、多テーマ・多執筆者でも視覚の一貫性を担保。記事の鮮度・カテゴリ感を一目で伝えるデザインシステムを構築</li><li><strong>専門家コンテンツの整流化：</strong> 各専門コンサルタント・外部執筆者から上がる原稿を編集・修正し、オーナー経営者が読み進めやすい形に整える。「マネーフォワード クラウド」連載のみ自ら取材・執筆まで完遂</li><li><strong>エコシステム連動：</strong> 単発のオウンドメディア記事に閉じず、メルマガ・YouTube・代表コラム「柴田昇の眼」と相互連動させ、継続的な接触機会を設計</li></ul>',
          role:'<strong>記事アイキャッチの統一デザイン / 執筆者・専門家との調整 / 原稿の編集・修正 / サムネイル制作 / アカウント契約 / 継続運用</strong> を一貫して担当。<strong>「マネーフォワード クラウド」連載 (全 3 回) のみ、企画・取材・執筆・作図まで単独で完遂</strong>。',
          creative:'<strong>「マネーフォワード クラウド」連載</strong>（企画・取材・執筆・作図・サムネイルまで単独で担当）<div class="wd-articles"><a class="wd-article-row" href="https://mikata-c.co.jp/media-list/business/lab_240126" target="_blank" rel="noopener"><div class="wd-article-thumb"><img src="img/works/work_25/media_mf_1_account.webp" alt="マネーフォワード クラウド連載 第1回 サムネ" loading="lazy" onerror="this.parentNode.style.display=\'none\'"></div><div class="wd-article-meta"><p class="wd-article-title">第1回 新規アカウントの登録方法</p><span class="wd-article-link">記事を読む ↗</span></div></a><a class="wd-article-row" href="https://mikata-c.co.jp/media-list/business/lab_240130" target="_blank" rel="noopener"><div class="wd-article-thumb"><img src="img/works/work_25/media_mf_2_renkei.webp" alt="マネーフォワード クラウド連載 第2回 サムネ" loading="lazy" onerror="this.parentNode.style.display=\'none\'"></div><div class="wd-article-meta"><p class="wd-article-title">第2回 銀行口座などの連携方法</p><span class="wd-article-link">記事を読む ↗</span></div></a><a class="wd-article-row" href="https://mikata-c.co.jp/media-list/business/lab_240131" target="_blank" rel="noopener"><div class="wd-article-thumb"><img src="img/works/work_25/media_mf_3_settei.webp" alt="マネーフォワード クラウド連載 第3回 サムネ" loading="lazy" onerror="this.parentNode.style.display=\'none\'"></div><div class="wd-article-meta"><p class="wd-article-title">第3回 事業者設定のおススメと注意点！</p><span class="wd-article-link">記事を読む ↗</span></div></a></div>',
          result:'<div class="wd-editorial-flow"><img src="img/works/work_25/owned_media_flow_redacted.webp" alt="MIKATA Lab. 編集フロー図 (匿名化済)" loading="lazy" onerror="this.parentNode.style.display=\'none\'"><p class="wd-flow-caption">編集フローを設計・運用（社内体制は匿名化）</p><p class="wd-flow-note">40日前から逆算した編集フローと、複数拠点の確認・ダブルチェック体制（QA）、ドライブ／管理シートでの進行管理まで設計・運用。</p></div><strong>コンテンツマーケのエコシステム連動：</strong><ul><li><strong>メディア:</strong> MIKATA Lab.（ビジネス／ファミリー／事業承継 カテゴリ、「柴田昇の眼」連載 ほか）</li><li><strong>⇄ メルマガ:</strong> 連載「柴田昇の眼」を第 4 回としてメルマガ配信し、媒体間で同一テーマを再接触させる導線</li><li><strong>⇄ ミカタチャンネル（YouTube）:</strong> 動画コンテンツと相互連動</li></ul>「マネーフォワード クラウド」連載 (全 3 回) では、「<strong>企画 → 取材 → 執筆 → 作図 → 公開 → メルマガ配信</strong>」の一連を単独で完遂。<br><br>広告を一切かけず、<strong>オーガニック検索（コンテンツSEO）経由で、継続的に問い合わせ・受注を創出</strong>。自身が企画・編集・デザインに関与した記事が検索流入の主要導線となり、事業の引き合いに直結しています。'
        }
      },
      {
        id:1, year:'2025',
        ...
        d:{
          overview:'ミカタ税理士法人のブランディング動画の<strong>企画・制作・配信のディレクション</strong>を担当。「経営と、人生の、味方になる。」というビジョンを軸に、<strong>2026年1月15日より</strong>、YouTube・TVerでの全国配信に加え、一部地域のタクシー広告・屋外大型ビジョンで展開中。',
      ...
      },
      {
        ...
        client:'ミカタ税理法人（ミカタグループ）',
        d:{
          overview:'ミカタグループのデジタルマーケティングにおいて、ディスプレイ広告（Paid）のクリエイティブ制作・改善提案と、オウンドメディア（Owned）の企画・制作を担当。データを見ながら継続的に改善し、獲得から育成までをクリエイティブ面で一貫して支えたプロジェクトです。',
          challenge:'新規の見込み客をいかに効率よく獲得し（Paid）、獲得後にいかに信頼を育てて関係を維持するか（Owned）という、ファネル全体の設計が課題でした。広告は設立期の起業家と既存中小企業で関心軸が異なり、オウンド側は専門知識が社外にほとんど届いていない状況。獲得と育成を分断せず、クリエイティブとコンテンツを一貫して設計する必要がありました。',
          ...
          result:'広告では、クリエイティブ改善を通じてクリック率（CTR）の向上と獲得コスト（CPA）の改善に寄与。オウンドメディアでは継続的なSEO発信で検索流入を増やし、代表コラムが対外発信の柱として機能しています。獲得（Paid）と育成（Owned）を連動させることで、属人的になりがちだった情報発信を会社として継続できる、フルファネルの運用体制を確立しました。',
          role:'広告クリエイティブの制作とデータに基づく改善提案、オウンドメディアの企画・制作を担当。広告＝AI活用・レタッチ・ABテストによるクリエイティブ改善とデータに基づく提案。オウンド＝テーマ選定（SEO）・記事制作・サムネイルデザイン・代表コラムの整理掲載。Paid広告のターゲット（ペルソナ・キーワード）を踏まえたオウンドコンテンツの最適化（Paid×Owned連携）。 ※ディスプレイ広告の入札・配信運用は広告代理店との分担体制。神田はクリエイティブ制作・改善提案・月次方針協議への参画を担当。'
        }
      },
      {
      ...
      },
      {
        ...
        client:'ミカタ税理法人（ミカタグループ）',
        d:{
          overview:'中小企業オーナー・経営者をターゲットに、税務・相続・経営の専門知識を動画コンテンツ化。<strong>企画MTGから撮影・編集・投稿・分析までを担当</strong>した、ミカタ税理士法人の公式YouTubeチャンネル運用プロジェクト。',
          ...
          result:'<ul><li>代表例として贈与の解説動画1本が、公開から数年経っても継続的に視聴され、累計45万回再生・この動画経由のチャンネル登録 約4,000件を記録。推定収益はチャンネル全体の約6割を生み続ける主力コンテンツに成長</li><li><strong>ペイドメディア連動：</strong> 直近は広告配信と連動したショート設計で月間 約11.7万人にリーチ、視聴継続率 60.9%（短尺広告として高水準）を達成</li></ul><br>→ 「課題発見 → 企画 → 制作 → 効果測定」を回し、コンテンツの価値を再生数・登録・継続率という数値で示せることの証明。',
          youtubeShort:'rFJLmQVPnyI',
          role:'企画MTGの参加 → 撮影 → 編集 → 投稿 → 分析まで担当。'
        }
      },
      {
        id:9, year:'2024',
        ...
        d:{
          overview:'相続というテーマを「7日間の講義形式の漫画本」に落とし込んだ書籍『<strong>マンガでカンタン！相続は７日間でわかります</strong>』（学研出版）の制作プロジェクトに、社内側の窓口として参画。学研より全国で出版・販売される書籍として結実し、複雑な専門知識を親しみやすい形で広く届ける媒体となった。',
          ...
          creative:'<ul><li><strong>読者が自己投影できる3キャラクター：</strong> 「面倒くさがりのマンガ家」「すご腕税理士」「好奇心旺盛な編集者」という登場人物が設定され、等身大の人物が学んでいく構成（キャラクター設定は出版社・制作側の提案をもとに選定）</li><li><strong>「見てわかる」情報設計：</strong> 相続手続きを<strong>すごろく形式</strong>で図解するなど、専門知識のない読者でも迷わず読み進められる視覚化を採用</li></ul>',
          result:'<ul><li><strong>学研より書籍として全国で出版・販売</strong></li><li>複雑な専門知識を「7日間で読める漫画本」という形に落とし込み、ミカタグループの知見を広く一般の方へ届ける<strong>媒体として機能</strong></li></ul>'
        }
      },
      {
        id:8, year:'2025',
      ...
      },
      {
        ...
        d:{
          ...
          role:'クリエイティブディレクター・デザイナーとして<strong>全工程を単独で担当</strong>。経営層への提案、代表撮影のフォトディレクション、グラフィックデザイン・作図・ライティング、カラー／フォントのシステム設計、3Dモデリング・レンダリングまでを内製で実行。<br>※ コーポレートロゴ（佐藤可士和氏）、表紙メインビジュアル（「山を登る経営者たち」墨絵風イラスト／制作会社）は既存資産。本プロジェクトでは、これらを正確に運用・統合した上で、各種資材と社章の制作・デザインを担当。',
          creative:'<ul><li><strong>信頼感を伝えるフォトディレクション：</strong> 代表撮影では「経営者の生涯のパートナー」としての誠実さを表現するため、表情・姿勢・照明・背景までを細部まで設計</li><li><strong>既存資産を活かした世界観の統合：</strong> 表紙のメインビジュアル（「山を登る経営者たち」モチーフの墨絵風イラスト／制作会社による既存制作物）は、<strong>先行して存在していたビジュアル資産を活用</strong>。コーポレートサイトのトンマナと整合する形で選定し、コーポレートカラーの黒・グレーのグラデーション・差し色の赤を精緻にコントロールしたデザインシステムへと統合。重厚感と親しみやすさが共存するブランド表現に仕上げた</li><li><strong>身にまとうブランドとしての社章：</strong> 金・銀の縁取りと立体加工の陰影を計算し、「プロフェッショナル」「信頼感」「高級感」を兼ね備えたエンブレムを設計</li></ul>',
      ...
      },
      {
        ...
        d:{
          overview:'全国の経営者を対象としたビジネスセミナーを、対面＋配信のハイブリッド形式でゼロから設計・運営。東京・大阪・名古屋・鹿児島・沖縄・軽井沢・六本木など全国各地で開催し、多くの会場で満員を達成したプロジェクト。',
