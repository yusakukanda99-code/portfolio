    ...
    const PF_WORKS = [
      {
        ...
        d:{
          overview:'母校の元教授・卒業生とともに立ち上げた地域アートイベントの企画・運営に、共同責任者の1人として参加。Instagramでの運用と現場運営（規約・搬入方法など）の両輪で、<strong>300名を超える方にご来場</strong>いただきました。',
          ...
          creative:'トリエンナーレの作品性に寄せつつ、幅広い層に届くよう<strong>櫃田氏デザインの親しみやすいポップなキャラクター</strong>をメインビジュアルに使用。明るいオレンジを基調に、動画ではキャラクターを大きく動かし効果音を添えて、初めて見る人でも気軽に手に取れる雰囲気を演出しました。',
